...
if os.path.exists(rf_metrics_path):
    ...
    comparison_frames.append(df_rf)
...
if comparison_frames:
    ...
    comparison_long = df_compare.melt(
        id_vars="Model",
        value_vars=available_columns,   # IMPORTANT
        var_name="Metric",
        value_name="Score"
    )
    ...
    st.success(
        f"✅ Based on F1-Score, **{best_model_name}** performs better overall."
    )
